                ...
                <form>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-gold" id="name" type="text" placeholder="Your Name">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2" for="email">Email Address</label>
                            <input class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-gold" id="email" type="email" placeholder="Your Email">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2" for="phone">Phone Number</label>
                            <input class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-gold" id="phone" type="tel" placeholder="Your Phone">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2" for="guests">Number of Guests</label>
                            <select class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-gold" id="guests">
                        ...
                        <div>
                            ...
                            <select class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-gold" id="time">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-gold" id="message" rows="3" placeholder="Any special requests or notes"></textarea>
                        </div>
                    </div>
